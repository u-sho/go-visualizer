...
export default function Page() {
  ...
  return (
    <div className="pt-16">
      <Header />
      <div className="flex flex-col sm:flex-row items-center sm:justify-between xl:justify-center min-h-screen p-1 pb-20 gap-16 sm:p-20 font-(family-name:--font-geist-sans)">
        {/* Game boardを画面の左側に固定 */}
